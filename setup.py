...
highly recommended to run GeoNotebook. Unfortunately there are no pip 
install-able versions of the bindings for Python 3. The Mapnik bindings 
will compile under Python 3 but they must be compiled and installed from 
source.  Please follow the instructions on the mapnik/python-mapnik 
repository, ensuring you can import mapnik before continuing to install 
GeoNotebook using Python 3.
        """)
